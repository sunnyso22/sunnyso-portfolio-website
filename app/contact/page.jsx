                ...
                <div className="flex flex-col xl:flex-row gap-[30px]">
                    ...
                    <div className="xl:w-[60%] order-2 xl:order-none">
                        <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
                            <h3 className="text-4xl text-accent font-medium">Let's work together</h3>
                            <p className="text-white/60">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Numquam possimus quo corporis ad enim id quia eius.</p>
                            {/* input */}
